...
class DoctorController extends Controller
{
    ...
    //{
      ...
      //$patient = User::orWhere('name', 'like', '%'.$search.'%')
       ...
       //$patient = User::all()->where('type','patient')->orWhere('validation','valid')
    ...
    public function addblood(Request $req)
    {
    	$blood = Blood::all();
    	return view('doctor.addBlood');
    }

     public function bloodlistCreate(Request  $req)
    {
            ...
            $validation = Validator::make($req->all(), [
                ...
                $req->session()->flash('msg', "Blood Is Added Successfully Added");
                
                return redirect()->route('doctor.addblood');
    }
    ...
    public function deleteblood($sid)
    {
       ...
       $s = Blood::find($sid);
       return view('doctor.deleteblood', ['d'=> $s]);
   ...
   public function destroyblood($sid)
   {
       ...
       Blood::destroy($sid);
       return redirect()->route('doctor.bloodlist');
   ...
   */
  public function generateInvoice($sid)
  {
      //$order = Order::find($id);
