...
<!-- Add Department -->
                ...
                <label>Patient Name</label>
                  ...
                  <label>Appointment Date</label>
                      <input type="text" class="form-control" name="date" placeholder="Give An Appointment Date">
                  <br>
                  <<!--label>Appointment Time</label>
                      <input type="time" class="form-control" name="time" placeholder="Give An Appointment Time">
                  <br>-->
